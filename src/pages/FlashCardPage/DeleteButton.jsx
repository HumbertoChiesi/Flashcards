...
const DeleteButton = (props) => {
    ...
    const fcID = props._id;

    function handleDelete(e){
        FlashCardService.delete("/flashcard/delete", {
            params: {
                requester: token,
                flashcard: fcID
            }
            ...
            function (error){
                alert("Could not delete the solicitation: " + error)
            }
        );
    }
   ...
   return(
       <div>
           <Button onClick={()=>{handlePopUp();}}>
               <DeleteOutlinedIcon sx={{ color: '#886ca1', width: '30px', height: '30px'}}/>
           </Button>
           {popUp === true
               ? <Backdrop
                   ...
                   <BoxStyled>
                       ...
                       <AtentionIconStyled/>
                       <TypographyStyled>Tem certeza que deseja excluir este</TypographyStyled>
                       <TypographyStyled>flash card?</TypographyStyled>
